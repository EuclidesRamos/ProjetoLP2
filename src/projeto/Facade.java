...
/**
 * Classe de fachada. Responsavel pela "comunicacao" entre a interface e o
 * codigo em si.
 * 
...
public class Facade {
	...
	public static void main(String[] args) {
		args = new String[] { "projeto.Facade", "testesDeAceitacao/use_case1.txt",
	...
	public int adicionaItemPorQtd(String nome, String categoria, int quantidade, String unidadeDeMedida,
		...
		return this.controllerItem.adicionaItemPorQtd(nome, categoria, quantidade, unidadeDeMedida, localDeCompra,
				preco);
	}
	 ...
	 * @return Retorna o descritor, no formato de String, da lista que foi
	 *         adicionada
	 */
	...
	/**
	 * Metodo responsavel por adicionar novas compras a lista ja cadastradas no
	 * sistema.
	 * 
	...
	/**
	 * Metodo responsavel por atualizar a quantidade de uma determinada compra em
	 ...
	 * @return Retorna uma representacao em String da lista que ests na posicao
