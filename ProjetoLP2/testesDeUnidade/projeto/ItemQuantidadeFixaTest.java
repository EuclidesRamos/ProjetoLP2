...
public class ItemQuantidadeFixaTest {
	...
	/**
	 * Instancia um item do tipo ItemQuantidadeFixa usado nos testes.
	 */
	@Before
	...
	/**
	 * Testa construir um item por quantidade fixa com nome vazio.
	 */
	...
	/**
	 * Testa construir um item por quantidade fixa com nome nulo.
	 */
	...
	/**
	 * Testa construir um item por quantidade fixa com categoria vazia.
	 */
	@Test(expected = IllegalArgumentException.class)
	...
	/**
	 * Testa construir um item por qquantidade fixa com categoria nula.
	 */
	@Test(expected = NullPointerException.class)
	...
	/**
	 * Testa construir um item por quantidade fixa com categoria inexistente.
	 */
	@Test(expected = IllegalArgumentException.class)
	...
	/**
	 * Testa construir um item por quantidade fixa com quantidade negativa.
	 */
	@Test(expected = IllegalArgumentException.class)
	...
	/**
	 * Testa construir um item por quantidade fixa com unidade de medida vazia.
	 */
	@Test(expected = IllegalArgumentException.class)
	...
	/**
	 * Testa construir um item por quantidade fixa com unidade de medida nula.
	 */
	@Test(expected = NullPointerException.class)
	...
	/**
	 * Testa construir um item por quantidade fixa com nome do local de compra
	 * vazio.
	 */
	@Test(expected = IllegalArgumentException.class)
	...
	/**
	 * Testa construir um item por quantidade fixa com nome do local de compra nulo.
	 */
	@Test(expected = NullPointerException.class)
	...
	/**
	 * Testa construir um item por quantidade fixa com preco negativo.
	 */
	@Test(expected = IllegalArgumentException.class)
	...
	/**
	 * Testa o metodo getUnidadeDeMedida.
	 */
