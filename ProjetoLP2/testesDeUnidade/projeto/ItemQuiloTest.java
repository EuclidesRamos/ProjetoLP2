...
/**
 * Responsavel pelos testes da classe ItemQuilo.
 * 
...
public class ItemQuiloTest {
	...
	/**
	 * Instancia um item do tipo ItemQuilo usado nos testes.
	 */
	@Before
	...
	/**
	 * Testa construir um item por quilo com nome vazio.
	 */
	...
	/**
	 * Testa construir um item por quilo com nome nulo.
	 */
	...
	/**
	 * Testa construir um item por quilo com categoria vazia.
	 */
	@Test(expected = IllegalArgumentException.class)
	...
	/**
	 * Testa construir um item por quilo com categoria nula.
	 */
	@Test(expected = NullPointerException.class)
	...
	/**
	 * Testa construir um item por quilo com categoria inexistente.
	 */
	...
	/**
	 * Testa construir um item por quilo com quantidade de quilos negativa.
	 */
	@Test(expected = IllegalArgumentException.class)
	...
	/**
	 * Testa construir um item por quilo com nome do local de compra vazio.
	 */
	@Test(expected = IllegalArgumentException.class)
	...
	/**
	 * Testa construir um item por quilo com nome do local de compra nulo.
	 */
	...
	/**
	 * Testa construir um item por quilo com preco negativo.
	 */
	...
	/**
	 * Testa atualizar a quantidade de quilos.
	 */
	@Test
